...
for DIR in "${DIRS[@]}"; do
    ...
    OUTPUT_PARENT_DIR="/home/azstephe/liverRegression/regression_liver/data/test_splits_eqn/${DIR}"
    ...
    for SPECIES in "${SPECIES_LIST[@]}"; do
        ...
        UNFILTERED_PEAK_FILE="/home/azstephe/liverRegression/regression_liver/data/ladder_qn/${SPECIES}_liver_pos_ALL.bed"
