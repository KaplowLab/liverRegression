...
def process_data(filename, base_dir):
    ...
    try:
        log_all = pd.read_csv(os.path.join(base_dir, 'log_transformed', filename), header=None, sep='\t')
        log_sorted = pd.read_csv(os.path.join(base_dir, 'log_sorted', filename), header=None, sep='\t')
        qn_included = pd.read_csv(os.path.join(base_dir, 'quantile_normalized', filename), header=None, sep='\t')
    ...
    output_dir = os.path.join(base_dir, 'extended_quantile_normalized')
